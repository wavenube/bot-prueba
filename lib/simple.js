...
reply: {
            ...
            value(jid, text = '', quoted, options) {
                return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: conn.parseMention(text), forwardedNewsletterMessageInfo: { newsletterJid: `120363318622514917@newsletter`, serverMessageId: '', newsletterName: 'Abys Bot' }, forwardingScore: 1, isForwarded: true, ...options }}, { quoted, ...options, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
            }
        },
                 //   sendButton: {
            /**
